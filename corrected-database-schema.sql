...
-- For now, keep RLS disabled to allow registrations to work
-- This is the simplest solution for testing
ALTER TABLE registrations DISABLE ROW LEVEL SECURITY;

-- If you want to enable RLS later with proper policies, use this instead:
